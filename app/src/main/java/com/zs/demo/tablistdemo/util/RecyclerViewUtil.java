...
package com.zs.demo.tablistdemo.util;
...
public class RecyclerViewUtil {
     ...
     * @param adapter
     */
    public static  void initGridScroll(Context context, RecyclerView recyclerView, RecyclerView.Adapter adapter,int spancount) {
     ...
     * @param spancount
     */
    public static  void initGrid(Context context, RecyclerView recyclerView, RecyclerView.Adapter adapter, int spancount) {
